...
import static com.matansabag.bgpsim.GraphProcessor.PATH_TYPE.LEGITIMATE;
...
public class RoutingTable {
 ...
 public RoutingTable(int as_number, BGPGraph graph,  boolean filter_by_length,  boolean filter_two_neighbours){
   this(as_number, graph, filter_by_length, filter_two_neighbours, false);
 }

  public RoutingTable(int as_number, BGPGraph graph,  boolean filter_by_length,  boolean filter_two_neighbours,  boolean is_real_dst){
...
//	cout << "consider_new_route appended_route->optattr_protected " << appended_route->optattr_protected << "\n";
  ...
  public int size() { return routing_table_.size(); }

  public Map<Integer, List<Route>> getRT() { return routing_table_; }

  public static void set_sorted_ases(SortedASVector  sorted_ases) { kSortedAses = sorted_ases; }
